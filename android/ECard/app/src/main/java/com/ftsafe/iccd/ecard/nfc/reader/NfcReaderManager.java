...
package com.ftsafe.iccd.ecard.nfc.reader;
...
import com.ftsafe.iccd.ecard.nfc.reader.pboc.StandardPboc;

import ftsafe.common.Util;


public final class NfcReaderManager extends AsyncTask<Tag, SPEC.EVENT, Card> {

	public static void readCard(Tag tag, NfcReaderListener listener) {
		new NfcReaderManager(listener).execute(tag);
	}

	private NfcReaderListener realListener;

	private NfcReaderManager(NfcReaderListener listener) {
