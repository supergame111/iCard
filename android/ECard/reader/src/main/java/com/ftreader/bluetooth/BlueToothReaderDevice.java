package com.ftreader.bluetooth;
...
public class BlueToothReaderDevice {
	private boolean isPowerOn = false;
	private Card inner_card;

	Handler mHandler;

	public BlueToothReaderDevice(String address, Context ctx) throws Exception {
		inner_card = new Card(address, ctx);
	}
